package tech.getarrays.employeemanagerapp.resource;
...
import tech.getarrays.employeemanagerapp.service.EmployeeService;
...
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> updateEmployee(@RequestBody Employee employee) {
        Employee updateEmployee = employeeService.updatEmployee(employee);
